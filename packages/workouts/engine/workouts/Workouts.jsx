        ...
        {screen === "list" && (
          <>
            ...
            <div className="wk-grid">
              ...
              {!collection && <button onClick={()=>setCollection("finger-legato")} style={{...panel,textAlign:"left",cursor:"pointer",color:C.white,padding:0,overflow:"hidden"}}><img src="/workouts/ultimate-legato-cover.png" alt="The Ultimate Legato Workout" style={{display:"block",width:"100%",height:"auto"}}/><div style={{padding:"22px 24px"}}><h2 style={{fontFamily:"Oswald"}}>The Legato Workout ↗</h2><p>Two, three and four fingers. Normal Legato or All Hammers.</p><span style={{color:C.purpleLt}}>Choose your combinations and position</span></div></button>}
